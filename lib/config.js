 ...
 * @property {Object} [asset={}] - Asset configuration
 * @property {boolean} [asset.faviconPng=true] - Favicon route. Set to `false` to disable favicon route
 * @property {boolean} [asset.robotsTxt=true] - Robots.txt route. Set to `false` to disable robots.txt route
 * @property {boolean} [asset.appCss=true] - App CSS route. Set to `false` to disable app CSS route
 * @property {boolean} [asset.appJs=false] - App JS route. By default it is disabled. Set to a string to enable it, e.g. '/asset/js/app.js'
